...
<body>
	...
	<nav class="nav nav-pills nav-fill">
	  <a class="nav-link active" href="..\php\admin_recruitment_pending_process.php">Pending</a>
...
$result = mysqli_query($con,"SELECT * FROM student WHERE application = 'Yes' AND status = 'Pending'");
