...
<body>
	...
	<nav class="nav nav-pills nav-fill">
	  ...
	  <a class="nav-link active" href="..\php\admin_recruitment_rejected_process.php">Rejected</a>
	</nav>
...
$result = mysqli_query($con,"SELECT * FROM student WHERE application = 'Yes' AND status = 'Reject'");
	...
	<table class="table table-bordered table-hover">
		...
		<tbody>
			<tr>
				...
				<td>
					<a class="btn btn-primary" href="admin_recruitment_review_process.php?id=<?php echo $row["studentId"]; ?>">Review</a>
				</td>
			</tr>
		</tbody>
