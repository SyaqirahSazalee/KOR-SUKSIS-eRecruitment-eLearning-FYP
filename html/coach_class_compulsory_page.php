...
<body>
  ...
  <nav class="nav nav-pills nav-fill">
    ...
    <a class="nav-link active" href="..\html\coach_class_compulsory_page.php">Compulsory Course</a>
  </nav>

  <br><br>

  <span  style="float: right; margin-right: 30pt;">
    <a style="background-color: #B4FF9F; color: black; text-decoration: none;" class="btn btn-primary" href="..\php\coach_class_compulsory_process.php">ADD MATERIAL</a>
  </span>
